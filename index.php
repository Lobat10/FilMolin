				...
				<div class="row">
					<div class="col-sm-8 col-md-7 py-4">
						...
						<p class="text-muted">FilMolin Cinema, es el nuevo cine con un
							...
							colas en la tienda. Los creadores y due帽os de este cine son Pablo
							Molina y Adri谩n Lobato.</p>
					</div>
    ...
    if (isset($_SESSION['login'])) {
		...
		<?php }else{?>
					 ...
					 <a href="./login/login.php" class="btn btn-primary btn-lg active"
						...
						style="float: right; clear: right;">Inicia sesi贸n</a>
...
if (isset($_GET['oferta'])) {
    ...
    if ($_GET['oferta'] == 1) {
		...
		<div class="container">
			...
			<p class="lead" style="color: white">A continuaci贸n os mostraremos la
					...
					<div class="form-group">
						<div class='input-group date' id='datetimepicker9'>
							...
							<div class="alert alert-info" style="align-items: center">
								<strong>Atenci贸n!</strong> Solo hay disponibilidad de las
...
if (isset($_GET['today'])) {
    if ($_GET['today'] == true) {
        ...
        $hoy = ", sesiones WHERE sesiones.filmcode = peliculas.filmcode and sesiones.date='".$a駉."-".$mes."-".$dia."'";
    }
}
...
while ($pelicula = $resultado->fetch_assoc()) {
    ...
    while ($sesion = $resultado2->fetch_assoc()) {
        ...
        echo "                                       <li><ul class='list-unstyled'>
                                                        ...
                                                        <li><p class='card-text'> Sala n潞 " . $sesion['roomcode'] . "</p><a href='./showSesion.php?code=" . $pelicula['filmcode'] . "&hora=".$sesion['timetable']."'><p class='btn btn-link'>" . $sesion['timetable'] . "</p></a></li>
                                                        <hr size='8px' color='blue' />
                                                     </ul>";
    }
    echo "                                      </ul>
